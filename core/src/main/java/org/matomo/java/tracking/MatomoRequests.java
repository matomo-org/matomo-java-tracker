...
public class MatomoRequests {
   ...
   *
   * <p>Make sure you have tracked a content impression using the same content name and content
   ...
   *
   * <p>If the Ecommerce order contains items (products), you must call {@link
   ...
   *
   * <p>The {@code query} parameter is required and should be the search query. The {@code category}
   ...
   *
   * <p>Ping requests do not track new actions. If they are sent within the standard visit length

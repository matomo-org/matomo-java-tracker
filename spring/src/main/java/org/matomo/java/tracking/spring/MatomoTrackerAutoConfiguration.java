...
public class MatomoTrackerAutoConfiguration {
   ...
   *
   * <p>If you define your own {@link TrackerConfiguration} bean, please don't forget to set the API
   * endpoint.
   *
   ...
   *
   * <p>Only created if a bean of the same type is not already configured. The filter is only
